...
BLOG_AUTHOR = "shirazpug"  # (translatable)
BLOG_TITLE = "ShirazPUG"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://shirazpug.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://shirazpug.github.io/"
BLOG_EMAIL = "shirazpug@gmail.com"
BLOG_DESCRIPTION = "Python community in Shiraz, Iran"  # (translatable)
...
NAVIGATION_LINKS = {
    ...
    "fa": (
        ("/fa/archive.html", "آرشیو"),
        ("/fa/categories/", "برچسب‌ها"),
        ("/fa/rss.xml", "خوراک"),
    ),
}
